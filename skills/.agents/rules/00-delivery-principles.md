...
5. **Behavioural rules** — What are the constraints, compliance requirements, or explicit
...
- Do not scaffold any code or pipeline until all five bootstrapping questions are answered
  and documented
